...
def test_templateDescription():
    ...
    assert (
        "Longest Night Stream December 2021 live performance by test artist from nowhere, US -- an excellent blend of music"
        == desc
    )
...
def test_templateReplaceLbForYT():
    ...
    assert (
        "Longest Night Stream December 2021 live performance by test artist from nowhere, US"
        + chr(13)
        + chr(10)
        + chr(13)
        + chr(10)
        + "an excellent blend of music"
        == desc
    )
